  ...
  BubbleChart = (function() {
    function BubbleChart(data) {
      ...
      this.get_updateSearch = __bind(this.get_updateSearch, this);
			this.get_updateSearch2 = __bind(this.get_updateSearch2, this);
			this.get_filter_vuosi = __bind(this.get_filter_vuosi, this);
...
//            return '#404040';
		...
		BubbleChart.prototype.updateSearch2 = function(searchTerm2) {
      var searchRegEx;
      searchRegEx = "nuoret";
      return this.circles.each(function(d) {
        var element, match;
...
//        content = "<span class=\"name\">" + title + ":</span><span class=\"value\"> " + value + "</span><br/>";
				...
				content += "<span class=\"name\">Kohderyhma:</span><span class=\"value\"> " + data.kohderyhma + "</span><br/>";
...
//        return d3.select(element).move_to_front();
    ...
    BubbleChart.prototype.filter_vuosi = function(vuosi) {
      return data = data.filter(function(d) {
        if (year === "kaikki") {
          return true;
        } else {
          return d.vuosi === vuosi;
        }
      });
		};
...
//      render_colors(csv);
    ...
    $('.time_nav.left').on('click', function(e) {
      ...
      var searchTerm2;
      searchTerm2 = $(this).val();
      return chart.updateSearch2(searchTerm2);
    });
